...
"[project]/app/admin/consultancy/requests/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ConsultationRequests() {
    ...
    const [budgetFilter, setBudgetFilter] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("All");
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ConsultationRequests.useEffect": ()=>{
            fetchRequests();
        }
    }["ConsultationRequests.useEffect"], []);
    /* ── ALL ORIGINAL LOGIC — UNCHANGED ── */ async function fetchRequests() {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("consultation_requests").select("*").order("created_at", {
            ascending: false
        });
        if (error) {
    ...
    /* ── BUDGET CATEGORIES ── */ const budgetCategories = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ConsultationRequests.useMemo[budgetCategories]": ()=>{
            const cats = new Set(requests.map({
                "ConsultationRequests.useMemo[budgetCategories]": (r)=>r.budget_range ?? "Unspecified"
            }["ConsultationRequests.useMemo[budgetCategories]"]));
            return [
                "All",
    ...
    /* ── FILTER + SORT ── */ const filteredSorted = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ConsultationRequests.useMemo[filteredSorted]": ()=>{
            const q = search.toLowerCase();
            return requests.filter({
                "ConsultationRequests.useMemo[filteredSorted]": (r)=>{
            ...
            }["ConsultationRequests.useMemo[filteredSorted]"]).sort({
                "ConsultationRequests.useMemo[filteredSorted]": (a, b)=>{
    ...
    /* ── GROUP BY BUDGET ── */ const grouped = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ConsultationRequests.useMemo[grouped]": ()=>{
            const map = {};
            filteredSorted.forEach({
                "ConsultationRequests.useMemo[grouped]": (r)=>{
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(SortBtn, {
                                sortDir: sortDir,
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: budgetCategories.map((cat)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(BudgetPill, {
                                label: cat,
                    ...
                    filteredSorted.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        style: {
                            display: "flex",
                        ...
                        lineNumber: 198,
                        columnNumber: 11
                    }, this) : showGrouped ? /* grouped by budget */ /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        style: {
                            display: "flex",
                            flexDirection: "column",
                            gap: 18
                        },
                        children: Object.entries(grouped).map(([budget, rows])=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        style: {
                                            display: "flex",
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(RequestTable, {
                                        rows: rows
                                    }, void 0, false, {
                                        fileName: "[project]/app/admin/consultancy/requests/page.tsx",
                                        lineNumber: 212,
                        ...
                        lineNumber: 204,
                        columnNumber: 11
                    }, this) : /* flat filtered table */ /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(RequestTable, {
                        rows: filteredSorted
                    }, void 0, false, {
                        fileName: "[project]/app/admin/consultancy/requests/page.tsx",
                        lineNumber: 218,
...
_s(ConsultationRequests, "Bw1vFE5Bh6YdoQhp0FX6JWEFdU8=");
_c3 = ConsultationRequests;
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("table", {
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                    children: rows.map((r, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(RequestRow, {
                            req: r,
                            index: i
                        }, r.id, false, {
                            fileName: "[project]/app/admin/consultancy/requests/page.tsx",
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                ...
                children: r.organization ?? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                    style: {
                        color: AMBER(0.2)
                    },
                    children: "—"
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                ...
                children: r.budget_range ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                    style: {
                        fontFamily: "'IBM Plex Mono',monospace",
                        fontSize: "0.5rem",
...
_s1(RequestRow, "9/uAcqUQPQAY6db9qMgZXXwbOpM=");
_c5 = RequestRow;
...
_s2(BudgetPill, "9/uAcqUQPQAY6db9qMgZXXwbOpM=");
_c7 = BudgetPill;
...
_s3(SortBtn, "9/uAcqUQPQAY6db9qMgZXXwbOpM=");
_c8 = SortBtn;
...
_s4(ExportBtn, "9/uAcqUQPQAY6db9qMgZXXwbOpM=");
_c9 = ExportBtn;
...
__turbopack_context__.k.register(_c3, "ConsultationRequests");
__turbopack_context__.k.register(_c4, "RequestTable");
__turbopack_context__.k.register(_c5, "RequestRow");
__turbopack_context__.k.register(_c6, "StatPill");
__turbopack_context__.k.register(_c7, "BudgetPill");
__turbopack_context__.k.register(_c8, "SortBtn");
__turbopack_context__.k.register(_c9, "ExportBtn");
...
//# sourceMappingURL=app_admin_consultancy_requests_page_tsx_6d22237a._.js.map