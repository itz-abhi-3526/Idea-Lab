        ...
        {isOpen && (
          ...
          >
            <div className="p-8 flex flex-col gap-6 items-center">
              ...
              <Link href="/execom" onClick={() => setIsOpen(false)} className="text-[12px] font-bold font-['Syne'] uppercase tracking-[0.4em] text-neutral-400 hover:text-orange-500">
                EXECOM
              </Link>
              <button 
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="relative inline-block px-4">
              <h1 className="text-[clamp(2.2rem,10vw,8.5rem)] font-black font-['Syne'] tracking-[-0.03em] uppercase leading-[1.1] 
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-6 mt-10 sm:mt-14 w-full max-w-md px-4">
            <Link href="/products" className="w-full sm:flex-1">
              ...
              >
                Explore Products <ArrowRight className="ml-1 sm:ml-2 w-3 h-3 sm:w-4 sm:h-4 group-hover:translate-x-1 transition-transform" />
              </Button>
            </Link>
