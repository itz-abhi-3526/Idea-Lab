      ...
      <section id="events" className="relative w-full py-16 sm:py-32 bg-black overflow-hidden border-t border-white/5">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
                    ...
                    <div className="flex flex-col lg:flex-row min-h-[400px]">
                      ...
                      <div className="p-8 sm:p-12 lg:w-1/2 flex flex-col justify-center">
                        ...
                        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4">
                          ...
                          <Link href={`/events/${featuredEvent.id}`} className="flex items-center justify-center gap-3 px-8 py-3 bg-white text-black rounded-xl font-black font-['Syne'] text-[10px] uppercase tracking-widest hover:bg-orange-500 transition-all">
                          ...
                          <div className="p-6 flex flex-col flex-grow">
                            ...
                            <div className="pt-5 border-t border-white/5 flex items-center justify-between">
                              ...
                              {alreadyReg ? (
                                ...
                                <Link href={`/events/${event.id}`} className="text-white font-black font-['Syne'] text-[9px] uppercase tracking-[0.2em] hover:text-orange-500 transition-all flex items-center gap-1.5">Register <ArrowRight size={10} /></Link>
                              )}
                            </div>
                          </div>
                        </m.div>
          ...
          <m.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} className="mt-16 sm:mt-24 flex justify-center">
            <Link href="/events" className="group flex items-center gap-4 px-8 py-4 border border-white/10 rounded-2xl text-neutral-400 font-['Syne'] uppercase text-[10px] tracking-[0.3em] font-bold hover:border-orange-500/50 hover:text-white transition-all">
